				...
				<section>
					<div>
						<div class="order-button">
							<button type="button" class="recommended-order" onclick="location.href='${pageContext.request.contextPath }/ClassLikeOne.cl'">추천순</button>
							<button type="button" class="latest-order" onclick="location.href='${pageContext.request.contextPath }/ClassLatestOne.cl'">최신순</button>
						</div>
